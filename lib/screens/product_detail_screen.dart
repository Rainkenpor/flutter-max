...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  Positioned productFooter(BuildContext context) {
    return Positioned(
      bottom: 0,
      left: 0,
      right: 0,
  ...
  CustomScrollView productInfo(BuildContext context) {
                ...
                return IconButton(
                  icon: Container(
                    ...
                    child: Icon(
                      ...
                      color: isFavorite ? AppColors.primary : AppColors.text,
                    ),
                  ),
                  onPressed: () {
                      ...
                      Row(
                        children: [
                          if (widget.product.hasDiscount) ...[
                            Text(
                              '\Q${widget.product.originalPrice!.toStringAsFixed(2)}',
                              style: const TextStyle(
                                fontSize: 18,
                                color: AppColors.textLight,
